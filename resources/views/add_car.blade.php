...
@section('content')
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form class="form form-horizontal" method="post" action="{{ route('car.store') }}">
                    {{ csrf_field() }}
                    <div class="section">
                        <div class="section-title">New Car Information</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="rent_per_hour" name="rent_per_hour">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
